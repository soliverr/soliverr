...
\newlanguagecommand{\researchengineer}
\addtolanguagecommand{\researchengineer}{english}{Research Engineer}
\addtolanguagecommand{\researchengineer}{russian}{Инженер-исследователь}
...
% https://courses.edx.org/certificates/1688d937ae3e42d8935858210cb81588
...
\cvitem{BigData}{Hadoop HDFS, YARN, Spark, pySpark, Spark-SQL, Hive, LLAP, ZooKeeper, Kafka, KafkaConnect, Ambari, HBase, Sqoop, Pandas, Kyuubi, Atlas, Trino, Kudo, Airflow, GreatExpectations, Apache Griffin, Debezium, Delta, Kubernetes, DASK, Celery, Redis}
...
\cvitem{Linux, Open Source}{\iflanguage{russian}{Участие в небольших проектах с открытым исходным кодом. Популяризация использования ОС Linux}{Open source project participating, Linux popularization}}
...
\cvlistitem{
\iflanguage{russian}
{Самообучаемость, желание делиться знаниями, ответственность}
