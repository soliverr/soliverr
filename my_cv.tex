...
%\phone[mobile]{+7~919~490~51~60}
\phone[mobile]{+7~922~324~10~10}
%\phone[fixed]{+2~(345)~678~901}
%\phone[fax]{+3~(456)~789~012}
\email{soliverr@gmail.com}                               % optional, remove / comment the line if not wanted
%\homepage{www.johndoe.com}                         % optional, remove / comment the line if not wanted
\social[linkedin]{sergey-kryazhevskikh-8128b2108}                        % optional, remove / comment the line if not wanted
%\social[twitter]{jdoe}                             % optional, remove / comment the line if not wanted
\social[github]{soliverr}                              % optional, remove / comment the line if not wanted
%\social[skype]{soliver_in_skype}
%\extrainfo{Skype soliver_in_skype}                 % optional, remove / comment the line if not wanted
% FIXME: добавить контакт skype: soliver_in_skype
\photo[64pt][0.4pt]{photo.jpeg}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
\iflanguage{russian}
...
%	\achievements:
%	\begin{itemize}
%		\item \iflanguage{russian}{ИТ Архитектура}{}
%		\begin{itemize}
%			\item \iflanguage{russian}{}{}
%			\item \iflanguage{russian}{}{}
%		\end{itemize}
%		\item \iflanguage{russian}{Разработка программного обеспечения}{}
%		\begin{itemize}
%			\item \iflanguage{russian}{}{}
%			\item \iflanguage{russian}{}{}
%		\end{itemize}
...
\cventry{2018--current}{\chiefsoftdeveloper}
...
{\iflanguage{russian}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \iflanguage{russian}{Управление и организация работы команды разработчиков: 5-12 человек}{}
			\item \iflanguage{russian}{Выбор системы ведения проекта: Jira, Trello, Asana, Ora.pm, Redmine}{}
			\item \iflanguage{russian}{Внедрение Scrumban в управление проектом: Ora.pm}{}
			\item \iflanguage{russian}{Внедрение Scrum Poker в планирование спринтов}{}
			\item \iflanguage{russian}
...
{\iflanguage{russian}
	...
	\item \iflanguage{russian}{ИТ Архитектура}{}
		\begin{itemize}
		\item \iflanguage{russian}{Разработана архитектуры отказоустойчивого кластера прикладного программного обеспечения}{}
		\item \iflanguage{russian}{Утверждение и защита решения у заказчика, написание технической документации}{}
		\end{itemize}
	\item \iflanguage{russian}{Разработка программного обеспечения}{}
		\begin{itemize}
			...
			{Oracle PL/SQL}
			\item \iflanguage{russian}{Oracle BI: Разработка и сопровождение форм Oracle BI}{}
			\item \iflanguage{russian}{Участие в разработке проектов на Java}{}
		\end{itemize}
	\item \iflanguage{russian}{Администрирование баз данных Oracle}{Oracle DBA}
		\begin{itemize}
			\item \iflanguage{russian}
...
%{\citykirov, \country}{}
%{\iflanguage{russian}
%{Внедрение и сопровождение СУБД PostgreSQL и MySQL в системах автоматизированного контроля и мониторинга на предприятиях энергетики.}
%{Deploy and maintain PostgreSQL and MySQL RDBMS for real-time automatic control systems in power industry.}\newline{}
%\achievements:
%\begin{itemize}
%	\item \iflanguage{russian}
...
%
% 2 Сфера деятельности: системное администрирование
%
%\iflanguage{russian}{\subsection{Системное администрирование}}{\subsection{System administration}}
...
%{}
%{\iflanguage{russian}
%{Сопровождение и поддержка информационных систем предприятия.}
%{Maintain enterprise computer-based systems.}\newline{}
%\achievements:
%\begin{itemize}
%	\item \iflanguage{russian}
...
%{Linux servers system administration.}\newline{}
%\achievements:
%\begin{itemize}
%	\item \iflanguage{russian}
...
%
% 3 Сфера деятельности "Программирование"
%
%\iflanguage{russian}{\subsection{Программирование}}{\subsection{Software Developing}}
...
%{}
%{\iflanguage{russian}
%{Разработка утилит для автоматизации задач сопровождения баз данных и серверов в домене Active Directory.}
%{Develop script for maintain users and servers in Active Directory domain.}\newline{}
%\achievements:
%\begin{itemize}
%	\item \iflanguage{russian}
...
%{\cityperm, \country}{}
%{\iflanguage{russian}
%{Разработка системы мониторинга оборудования связи.}
...
%\cventry
%{1995--2004}
%{\leadsoftdeveloper, \leadscientist}
%{\protect\httplink[\ors]{www.ors.kirov.ru}}
%{\citykirov, \country}{}
%{\iflanguage{russian}
%{Разработка автоматизированной системы контроля и управления объектами энергетики.}
%{Desing computer control system in power industry.}\newline{}
%\achievements:
%\begin{itemize}
%	\item \iflanguage{russian}
...
%}
%
%\iflanguage{russian}{\pagebreak}{ }
%
%\iflanguage{russian}{\subsection{Конструирование и схемотехника}}{\subsection{Desing and Circuit Engineering}}
%
%\cventry{2004--2006}
%{\designengineer}
%{\protect\httplink[\simos]{www.simos.ru}}
%{\cityperm, \country}{}
%{\iflanguage{russian}
%{Разработка встраиваемых модулей для систем дальней проводной связи на базе Atmel AVR.}
%{Design Atmel AVR embedded progammable units for line wired telecommunication.}\newline{}
%\achievements:
%	\begin{itemize}
%		\item \iflanguage{russian}
...
%{\citykirov, \country}{}
%{\iflanguage{russian}
%{Разработка программируемых логических контроллеров на базе Intel 80C51 и x86. Оформление конструкторской документации.}
%{Desing Intel 80C51 and x86 programmable logic controllers. Design drafting and working construction documents.}\newline{}
%\achievements:
%	\begin{itemize}
%		\item \iflanguage{russian}
...
%}
%
%\iflanguage{russian}{\subsection{Научно-исследовательская работа}}{\subsection{Research Engineering}}
...
%{\citykirov, \country}{}
%{\iflanguage{russian}
%{Разработка и внедрение автоматических систем нечёткого управления (fuzzy control) объектами энергетики на промышленных предприятиях города и области.}
%{Automatic fuzzy control system development in a power energetic industry and energetic operating companies.}\newline{}
%\achievements:
%\begin{itemize}
%	\item \iflanguage{russian}
...
\cvdoubleitem{\iflanguage{russian}{Сеть}{Network}}{TCP/IP, DNS, DHCP, LDAP}{\iflanguage{russian}{Документация}{Docs}}{\LaTeX, DoxyGen}
